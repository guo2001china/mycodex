...
For installation or usage help, use GitHub Issues. Good reports are specific: platform, installer filename, MyCodex version, what you clicked, what happened, and a screenshot if there is an error.
...
Do not post tokens, API keys, cookies, or private files in public issues.
