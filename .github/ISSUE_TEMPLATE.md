...
Please use the structured issue forms when possible:
...
- Localization feedback: https://github.com/guo2001china/mycodex/issues/new?template=localization.yml
...
Latest release notes: https://github.com/guo2001china/mycodex/blob/main/docs/releases/v0.9.68.md
