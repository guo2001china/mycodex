...
Maintainers may edit, hide, lock, or remove content that puts users at risk or makes the project harder to use. Security-sensitive reports should start with a high-level public issue and move private details to a safer channel.
